                ...
                <table id="style-3" class="table style-3  table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="width: 350px" class="text-center"> {{ $co->user->nama }} </td>
                            <td style="width: 350px" class="text-center"> {{ $co->jam }} </td>
                            <td style="width: 350px" class="text-center"> {{ $co->keterangan }} </td>
